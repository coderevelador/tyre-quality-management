                    ...
                    <div class="card-body col-md-8">
                        ...
                        <div style="width: 100%; height: 20px; border-bottom: 1px solid black; text-align: center">
                            <span style="font-size: 30px; background-color: #ffffff; padding: 0 10px;">
                                Generate Reports AIS
                                <!--Padding is optional-->
                            </span>
                        </div><br>

                        <form method="post" action="{{ route('store_reports_ais') }}">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>HTAC No.</label>
                                    <input type="text" class="form-control" name="htac" placeholder="HTAC No."
                                        required>
                                </div>
                                @error('htac')
                                ...
                                <div class="form-group col-md-6">
                                    <label>ULR No. </label>
                                    <input type="text" class="form-control" name="ulr" placeholder="ULR No."
                                        required>
                                </div>
                                @error('ulr')
                                    <div class="invalid-feedback d-block" role="alert">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="tyre_class"
                                        placeholder="Tyre Class" required>
                                </div>
                                @error('tyre_class')
                                    <div class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="skim_load"
                                        placeholder="SKIM Load(kg)" required>
                                </div>
                                @error('skim_load')
                                    <div class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="test_rim_material"
                                        placeholder="Test Rim Material" required>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        placeholder="Initial Rolling Resistance Coeffiecient N/kN" required>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <select name="rolling_resistance_label" id="RollingResistanceLabel"
                                        ...
                                        <option value="rolling_resistance_value_1.7">
                                            Rolling resistance coefficient-AIS-142,Annex-D(25°C,1.7m)N/kN</option>
                                        <option value="sound_level_value">Sound level according to AIS-142 of Annex-A(dBA)
                                        </option>
                                        <option value="wet_grip_value"> Wet grip Index according to AIS-142 of Annex-C
                                        </option>
                                    </select> <br>
                                    <input type="text" class="form-control"
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control"
                                    ...
                                    placeholder="Temperature & Drum Diameter Corrected Rolling Resistance Coeffiecient (25°C, 2m) N/kN"
                                    required>
                            </div>
