            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body col-md-8">
                        ...
                        <form method="post" action="{{ route('update_reports', $generate_reports->id) }}"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="drum_surface"
                                        value="{{ $generate_reports->drum_surface }}" id="drum_surface_placeholder"
                                        required>
                                </div>
                                @error('drum_surface')
                                    <div class="invalid-feedback d-block" role="alert">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="drum_diameter"
                                        value="{{ $generate_reports->drum_diameter }}" id="drum_diameter_placeholder"
                                        required>
                                </div>
                                @error('drum_diameter')
                                    <div class="invalid-feedback d-block" role="alert">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="thermal_conditioning_load"
                                        placeholder="Load rL(m)" required
                                        value="{{ $generate_reports->thermal_conditioning_load }}">
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="thermal_conditioning_skim"
                                        placeholder="Skim rL(m)" required
                                        value="{{ $generate_reports->thermal_conditioning_skim }}">
                                </div>
                            ...
                            <div class="form-group ">
                                <select name="rolling_resistance_label" id="RollingResistanceLabel" class="form-control">
                                    ...
                                    <option value="wet_grip_value"
                                        ...
                                        Wet Grip Index % </option>
                                </select> <br>
                                <input type="text" class="form-control" name="rolling_resistance_coeffecient"
                                    value="{{ $generate_reports->rolling_resistance_coeffecient }}" id="rollingResistanceValue" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="approved_by"
                                        placeholder="Approved By" required value="{{ $generate_reports->approved_by }}">
                                </div>
                                @error('approved_by')
                                    <div class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="test_witnessed"
                                        ...
                                        value="{{ $generate_reports->test_witnessed }}">
