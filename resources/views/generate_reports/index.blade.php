    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Generated ECE Reports</h4>
                        <div class="col-xs-12" style="float:right;">
                            <div class="row">
                                <div class="col-xs-6">
                                    <form action="{{ route('all_reports') }}" method="GET">
                                ...
                                <tbody>
                                    @foreach ($generate_reports as $generate_report)
                                        <tr>
                                            ...
                                            <td> <a href="{{ route('pdf1', $generate_report->id) }}"
                                                    class="btn btn-info }}" style="color:white;">PDF</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('edit_reports', $generate_report->id) }}"
                                                    class="btn btn-primary">Edit</a>
                                                <a href="{{ route('delete_reports', $generate_report->id) }}"
